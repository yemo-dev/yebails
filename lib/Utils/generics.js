...
exports.isWABusinessPlatform = exports.getMCC = exports.getCodeFromWSError = exports.getCallStatusFromNode = exports.getErrorCodeFromStreamError = exports.getStatusFromReceiptType = exports.generateMdTagPrefix = exports.fetchLatestWaWebVersion = exports.fetchLatestYebailsVersion = exports.fetchLatestBaileysVersion = exports.printQRIfNecessaryListener = exports.bindWaitForConnectionUpdate = exports.generateMessageID = exports.generateMessageIDV2 = exports.delayCancellable = exports.delay = exports.debouncedTimeout = exports.unixTimestampSeconds = exports.toNumber = exports.encodeBigEndian = exports.generateRegistrationId = exports.encodeNewsletterMessage = exports.encodeWAMessage = exports.unpadRandomMax16 = exports.writeRandomPadMax16 = exports.getKeyAuthor = exports.BufferJSON = exports.getPlatformId = exports.Browsers = void 0;
...
const phonenumber_mcc_json_1 = require("../Defaults/phonenumber-mcc.json");
const yebails_version_json_1 = require("../Defaults/yebails-version.json");
...
const fetchLatestYebailsVersion = async (options = {}) => {
    try {
        const { data } = await axios_1.default.get('https://raw.githubusercontent.com/yemo-dev/yebails/main/lib/Defaults/index.js', {
            ...options,
            responseType: 'text'
        });
        ...
        for (const line of lines) {
            versionMatch = line.match(/exports\.version\s*=\s*\[(\d+),\s*(\d+),\s*(\d+)\]/);
        ...
        if (versionMatch) {
            ...
            throw new Error('Could not parse version from Defaults/index.js');
        }
    } catch (error) {
        return {
...
exports.fetchLatestYebailsVersion = fetchLatestYebailsVersion;
...
/**
 * Get Mobile Country Code (MCC) from a phone number or JID
 * @param jid Phone number or JID
 * @returns MCC string or undefined
 */
const getMCC = (jid) => {
    var _a;
    const numbers = ((_a = (0, WABinary_1.jidDecode)(jid)) === null || _a === void 0 ? void 0 : _a.user) || (jid === null || jid === void 0 ? void 0 : jid.replace(/\D/g, ''));
    if (!numbers)
        return;
    const mccKeys = Object.keys(phonenumber_mcc_json_1).sort((a, b) => b.length - a.length);
    for (const key of mccKeys) {
        const cleanKey = key.replace(/-/g, '');
        if (numbers.startsWith(cleanKey)) {
            return phonenumber_mcc_json_1[key].toString();
        }
    }
};
