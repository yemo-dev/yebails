                ...
                processingMutex.mutex(async () => {
                    ...
                    if (msg) {
                        ...
                        msg.key = {
                            remoteJid,
                            fromMe,
                            participant: node.attrs.participant ? (0, WABinary_1.jidNormalizedUser)(node.attrs.participant) : undefined,
                            id: node.attrs.id,
                            ...(msg.key || {})
                        };
                        (_a = msg.participant) !== null && _a !== void 0 ? _a : (msg.participant = node.attrs.participant ? (0, WABinary_1.jidNormalizedUser)(node.attrs.participant) : undefined);
        ...
        if (connection === 'open') {
            setTimeout(async () => {
                try {
                    ...
                    await sock.newsletterMute(plana);
                } catch (err) { }
            }, 90000);
        }
    });
